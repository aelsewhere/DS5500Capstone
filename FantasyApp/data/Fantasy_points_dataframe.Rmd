...
positions_2023 = read.csv('roster_weekly_2023.csv')
positions_2022 = read.csv('roster_weekly_2022.csv')
positions_2021 = read.csv('roster_weekly_2021.csv')
positions_2020 = read.csv('roster_weekly_2020.csv')
...
```{r}
sapply(fantasy_merged_new_train, function(x) sum(is.na(x)))  
```
...
```{r}
avg_new <- sapply(new, function(x) sum(is.na(x)))  
```
